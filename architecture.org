...
Emacs itself proved unusable as a [[https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/Native_messaging][native-messaging]] client.

* Level 0

Low level communication between browser and Emacs in terms of bytes sent over
websockets.
