...
You will need to make sure that following software are available in your
=$PATH=.

1. Node.js (and npm), for building the spookfox add-on
...
- Log state-changing events
  ...
  To see various levels of logged messages, please set =DEBUG= to a
